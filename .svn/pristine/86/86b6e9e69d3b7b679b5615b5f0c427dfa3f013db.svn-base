...
public class DialogManager {
    ...
    public void initDialog() {
        ...
        mDeleteImage = (ImageView) mDialog.findViewById(R.id.iv_delete);
    ...
    public void showRecordingDialog() {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            mRecordImage.setImageResource(R.drawable.recording_recording_indicator_voice_1);
            //mTimeText.setText("");
    ...
    public void showCancelDialog() {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            mDeleteImage.setImageResource(R.mipmap.recording_delete_indicator);
    ...
    public void showVoiceUpdateDialog(int level, float time) {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            // 显示录音时长
            String audioTime = Math.round(time) < 10 ? "0" + Math.round(time) : "" + Math.round(time);
            mTimeText.setText("0:" + audioTime);
            mInfoText.setText(mContext.getResources().getString(R.string.move_cancel_send));
        }
    }
